...
3. Run `./setup.sh`, then `./course.py build 00` — the sample lecture should
   PASS with all gates green. Then put your lecture sources in `source/`
   and hand the repository to your agentic AI tool ("Read AGENTS.md, then
   begin lecture 1 from source/lecture01.pdf") — your side of the loop is
